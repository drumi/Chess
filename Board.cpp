...
void Board::init()
{
    ...
    m_board[0][1] = Piece(false, PieceType::BISHOP);
    m_board[0][2] = Piece(false, PieceType::KNIGHT);
    ...
    m_board[7][1] = Piece(true, PieceType::BISHOP);
    m_board[7][2] = Piece(true, PieceType::KNIGHT);
